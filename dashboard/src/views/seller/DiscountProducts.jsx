        ...
        <tbody>
            {
                ...
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>{d}</td>
                ...
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>Men Full Sleeve</td>
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>Tshirt</td>
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>Veirdo </td>
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>$232</td>
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>10%</td>
                <td scope='row' className='px-4 py-1 font-medium whitespace-nowrap'>20</td>
